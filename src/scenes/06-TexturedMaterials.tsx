...
export default class TexturedMaterialsScene extends Scene {
    ...
    public load(): void {
        ...
        this.game.loader.load({
            ...
            ["suzanne"]:{url:'models/obstacles/1.obj', type:'text'},
            ["ob"]:{url:'models/obstacles/1.obj', type:'text'},
            ...
            ["metal.albedo"]:{url:'images/rune/albedo.jpg', type:'image'},
            ["metal.roughness"]:{url:'images/rune/roughness.jpg', type:'image'},
            ["metal.specular"]:{url:'images/rune/specular.jpg', type:'image'},
            ...
            ["suzanne.ao"]:{url:'images/rune/ao.jpg', type:'image'},
        });
    } 
