...
export default class TrackScene extends Scene {
    ...
    public draw(deltaTime: number): void {
        ...
        this.objects['ground'].modelMatrix = mat4.fromRotationTranslationScale(mat4.create(), quat.create(), vec3.fromValues(0, 0, 360*this.time/10000), vec3.fromValues(3.5, 1, 1000));
